...
class AppColors {
  ...
  // App theme colors
  static const Color primary = Color(0xFF0b2b40);
  static const Color secondary = Color(0xFF856123);
  // static const Color secondary = Color(0xFFa17f39);
  static const Color third = Color(0xFFba9453);
  static const Color accent = Color(0xFFE2F6FF);
  ...
  static const Color dark = Color(0xff020c1a);
